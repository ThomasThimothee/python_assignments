...
imdb_csv = pd.read_table("../assignment_4/title.basics.tsv.gz", compression="gzip", sep="\t", dtype={"startYear" : str})
...
def question_3():
    ...
    test = [np.nan if value == "\\N" else int(value) for value in imdb_csv_filtered.runtimeMinutes]
